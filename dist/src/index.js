...
exports.getVideo = exports.getCategoryMV = exports.getListMV = exports.search = exports.getLyric = exports.getArtist = exports.getInfoSong = exports.getNewReleaseChart = exports.getChartHome = exports.getTop100 = exports.getHome = exports.getDetailPlaylist = exports.getSong = exports.searchSongs = void 0;
...
const hashParamSongSearch = (path, type, page, count) => {
    if (count == undefined && page == undefined) {
        return getHmac512(path + getHash256(`ctime=${CTIME}type=${type}version=${VERSION}`), SECRET_KEY);
    }
    else {
        return getHmac512(path +
            getHash256(`count=${count}ctime=${CTIME}page=${page}type=${type}version=${VERSION}`), SECRET_KEY);
    }
};
...
// @ts-ignore
const searchSongs = (keyword, page, count) => __awaiter(void 0, void 0, void 0, function* () {
    const url = "/api/v2/search";
    return yield requestZingMp3(url, {
        q: keyword,
        type: "song",
        page,
        count,
